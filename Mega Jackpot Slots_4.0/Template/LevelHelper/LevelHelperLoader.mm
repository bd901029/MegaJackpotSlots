...
//    NSLog(@"screen width height %f %f",screenSize.width,screenSize.height);
//    
//    float fix = 1;
...
//    }
//    
//	[[LHSettings sharedInstance] setLhPtmRatio:ratio/(fix)];///(2.22f)];
...
+(void)setLHPTM:(float)ratio_{
    
    [[LHSettings sharedInstance] setLhPtmRatio:ratio_];
